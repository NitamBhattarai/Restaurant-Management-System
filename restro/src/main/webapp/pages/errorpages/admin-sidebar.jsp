...
<aside class="w-48 bg-white border-r border-black/10 fixed top-0 bottom-0 left-0 z-30 flex flex-col overflow-y-auto">
  ...
  <div class="mt-auto px-4 py-5 border-t border-black/10">
    <div class="flex items-center gap-3 mb-4">
      ...
      <div class="min-w-0">
        <div class="text-[13px] font-semibold text-ink leading-tight truncate">${currentUser.fullName}</div>
        <div class="text-[11px] text-muted truncate">${currentUser.email}</div>
      </div>
    </div>
