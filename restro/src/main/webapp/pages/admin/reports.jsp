...
uri="http://xmlns.jcp.org/jsp/jstl/core" %> <%@ taglib prefix="fmt"
uri="http://java.sun.com/jsp/jstl/fmt" %>
<c:set var="pageTitle" value="Financial Reports" />
<%@ include file="/pages/errorpages/header.jsp" %> <%@ include
file="/pages/errorpages/admin-sidebar.jsp" %>
...
<div class="ml-48 min-h-screen bg-[#fbfaf7]">
  ...
  >
    ...
    <div class="flex items-center gap-4">
      <div
        class="w-64 bg-[#f7f5f1] border border-black/6 rounded-full px-4 py-2 text-[12px] text-muted"
      >
        Search reports...
      </div>
  ...
  <div class="p-6">
    <div class="grid grid-cols-[2fr_1fr] gap-5 mb-5">
      ...
      <div class="bg-white rounded-xl border border-black/8 p-6">
        ...
        <div class="text-[#2f9b6d] font-semibold text-[14px] mb-5">
          +18.4%
          <span class="text-muted font-normal text-[11px]">vs this month</span>
        </div>
        <div
          class="rounded-lg bg-[#faf7f2] border border-black/6 px-4 py-3 text-[11px] text-muted leading-relaxed"
        >
          “Growth driven by upcoming holiday weekend and high demand for
          seasonal specials.”
        </div>
      </div>
    </div>
        ...
        <div class="space-y-4">
          <div>
            <div class="flex justify-between text-[12px] mb-2">
              ...
              ><span class="text-forest font-semibold">72% Margin</span>
            </div>
            <div class="h-1.5 rounded-full bg-paper3">
              <div class="h-full w-[72%] bg-forest rounded-full"></div>
            </div>
          </div>
          <div>
            <div class="flex justify-between text-[12px] mb-2">
              <span class="text-muted">Entrees</span
              ><span class="text-forest font-semibold">38% Margin</span>
            </div>
            <div class="h-1.5 rounded-full bg-paper3">
              <div class="h-full w-[38%] bg-forest rounded-full"></div>
            </div>
          </div>
          <div>
            <div class="flex justify-between text-[12px] mb-2">
              <span class="text-muted">Desserts</span
              ><span class="text-forest font-semibold">54% Margin</span>
            </div>
            <div class="h-1.5 rounded-full bg-paper3">
              <div class="h-full w-[54%] bg-forest rounded-full"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="absolute left-5 bottom-5 text-white">
          ...
          <div class="text-[11px] text-white/70 mb-3">
            452 units sold this month
          </div>
          <div class="text-[12px] text-white/70">
            Total Revenue
            <span class="text-white font-semibold ml-3">Rs 429,400</span>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white rounded-xl border border-black/8 p-5 mb-5">
      <div class="flex items-center justify-between mb-4">
        <div>
          <div class="text-[18px] font-semibold text-ink">
            Daily Revenue Trends
          </div>
          <div class="text-[12px] text-muted">
            Historical performance vs AI predictions
          </div>
        </div>
      ...
      <div class="grid grid-cols-7 gap-3 items-end h-72">
        ...
        <div class="bg-[#184d3f] rounded-t h-[82%] relative">
          <span
            class="absolute -top-6 left-2 text-[10px] bg-[#1f1f1f] text-white rounded px-2 py-1"
            >Today 11.7k</span
          >
        </div>
        <div class="bg-[#d7efe4] rounded-t h-[88%] relative">
          <span
            class="absolute -top-6 left-2 text-[10px] bg-[#2c6b57] text-white rounded px-2 py-1"
            >AI Forecast</span
          >
        </div>
      ...
      <div class="space-y-4">
        <div class="bg-[#eef8f4] rounded-xl p-5 border border-[#d8ece3]">
          ...
          <div class="text-[12px] text-muted leading-relaxed">
            Lentil prices increased by 14%. Suggestion: adjust Dal Bhat menu
            item to maintain margin.
          </div>
        </div>
        <div class="bg-[#211f1c] rounded-xl p-5 text-white">
          ...
          <div class="text-[12px] text-white/70 leading-relaxed mb-4">
            Projected high-volume traffic for Saturday evening. Recommend 2
            floor staff to optimize service speed.
          </div>
          <button
            class="w-full rounded-lg bg-white/10 py-3 text-[11px] font-semibold uppercase tracking-[0.14em]"
          >
            Review Schedule
          </button>
        </div>
